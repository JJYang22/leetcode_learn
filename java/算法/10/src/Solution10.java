...
//        s.isMatch(s1,p1);
     System.out.println(s.isMatch(s2,p2));
    ...
    private boolean temp(String s,String p)
    {
        ...
        if (p.length() > 1)
        {
            if ( p.charAt(1) ==  '*' )
            {
                ...
                {
                    s_end = 0;
                    if ( p_end >= p.length() && p.charAt(0) == '.')
                        return true;
                    else
                    {
                        while ( s_end <= s.length() )
                        {
                            System.out.println("1s_end="+s_end);
                            System.out.println("1p_end="+p_end);
                ...
                else
                {
                    if(p_end <p.length())
                    {
                        System.out.println("2p_end="+p_end);
        ...
        if ( p.charAt(0) == s.charAt(0) || p.charAt(0) == '.' )
        {
            ...
            {
                System.out.println("3s_end="+s_end);
                System.out.println("3p_end="+p_end);
